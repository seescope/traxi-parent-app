...
const MOCK_DATA = [
  {
    Category: 'Business',
    Logo:
      'http://is1.mzstatic.com/image/thumb/Purple127/v4/b8/bd/5e/b8bd5ebb-4cd9-b529-ddf3-22a1f9a497ba/source/512x512bb.jpg',
...
describe('getInitialUsage', () => {
  ...
  test.only('getInitialUsage() works proprely with a previous state', () => {
    const mockStore = configureMockStore([thunk]);
    const store = mockStore({
      parentState: {
        kids: [
