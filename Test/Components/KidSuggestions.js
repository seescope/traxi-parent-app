...
const TEST_KID_SUGGESTIONS = [
  ...
  },
  {
    name: 'Jen Bastian',
    phoneNumber: '+61401633346',
    avatarURL: 'https://yoknyamdabale.files.wordpress.com/2012/02/530847_362873373757396_221256177919117_1086583_339624364_n.jpg',
  },
];
const onPress = sinon.spy();
const wrapper = shallow(
  <KidSuggestions kidSuggestions={TEST_KID_SUGGESTIONS} onPress={onPress} />,
);
...
describe('<KidSuggestions />', () => {
  ...
  it('calls the onPress handler on each kid suggestion', () => {
    ...
    TEST_KID_SUGGESTIONS.forEach(k =>
      expect(onPress.calledWith(k)).to.equal(true));
  });
});
